...
export const Modal = ({ header, body, footer, handleClose }) => {
  ...
  return (
    <div className="flexCenter fixed inset-0 z-10 bg-overlay-black animated fadeIn" onClick={handleClickOutside}>
      <div ref={modalRef} className="w-11/12 md:4/5 minlg:w:2-4 dark:bg-nft-dark bg-white flex flex-col rounded-lg">
