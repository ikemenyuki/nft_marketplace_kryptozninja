...
const SearchBar = ({ activeSelect, setActiveSelect, handleSearch, onClearSearch }) => {
  ...
  return (
    <>
      ...
      <div className="relative flexBetween ml-4 sm:ml-0 sm:mt-2 min-w-190 cursor-pointer dark:bg-nft-black-2 bg-white border dark:border-nft-black-2 border-nft-gray-2 py-3 px-4 rounded-md" onClick={() => setToggle((prev) => !prev)}>
