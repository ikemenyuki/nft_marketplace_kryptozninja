...
const Home = () => {
  ...
  const isScrollable = () => {
    ...
    if (current?.scrollWidth >= parent?.offsetWidth) setHideButtons(false);
      ...
      <div className="flex justify-center sm:px-4 p-12">
        <div className="w-full minmd:w-4/5">
          <Banner
            ...
            parentSytles="justify-start mb-6 h-72 sm:h-60 p-12 xs:p-4 xs:h-44 rounded-3xl"
          />
            ...
            <>
              ...
              <div className="mt-10">
                <div className="flexBetween mx-4 xs:mx-0 minlg:mx-8 sm:flex-col sm:items-start">
                  ...
                  <div className="flex-2 sm:w-full flex flex-row sm:flex-col px-4 xs:px-0 minlg:px-8">
                    <SearchBar
