  ...
  <div className="flex flex-col">
    ...
    <div>
      ...
      <div className="flexBetween mt-10">
        <p className="font-poppins dark:text-white text-nft-black-1 font-normal text-base minlg:text-xl">Total <span className="font-semibold">{nftCurrency}</span></p>
        <p className="font-poppins dark:text-white text-nft-black-1 font-normal text-sm minlg:text-xl">{nft.price} <span className="font-semibold">{nftCurrency}</span></p>
      </div>
    </div>
  </div>
...
const NFTDetails = () => {
  ...
  const [nft, setNft] = useState({ image: '', tokenId: '', name: '', owner: '', price: '', selle: 'r' });
      ...
      <div className="flex-1 justify-start sm:px-4 p-12 sm:pb-4">
        ...
        <div className="mt-10">
          ...
          <div className="flex flex-row items-center mt-3">
            <div className="relative w-12 h-12 minlg:w-20 minlg:h-20">
        ...
        <div className="mt-10 flex flex-col">
          <div className="w-full border-b dark:border-nft-black-1 border-nft-gray-1 flex flex-row">
            <p className="font-poppins dark:text-white text-nft-black-1 text-base minlg:text-base font-medium mt-2">Details</p>
          </div>
          <div className="mt-3">
