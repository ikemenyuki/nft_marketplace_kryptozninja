...
const projectId = '2EkPbGkaGfAEBkghPsQjWzgqKY9';
const projectSecret = 'f98523ecba5123c7931059054c49fee2';
...
const CreateNFT = () => {
  ...
  const onDrop = useCallback(async (acceptedFile) => {
    setPaths(acceptedFile.map((file) => URL.createObjectURL(file)));
